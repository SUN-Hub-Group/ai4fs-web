                        ...
                        <div class="blog-details-content">
                            ...
                            <div class="inner-box">
                                ...
                                <figure class="image-box">
                                    ...
                                    <img src="assets/images/news/<?php echo $image;?>" alt="" width="100%">

                                </figure>

                                <div class="lower-content">

                                    <span class="post-date"><i class="fa fa-calendar-alt pr-2"></i><?php echo date("M, d Y", strtotime($created_at)); ?></span>
                                ...
                                <div class="post-inner">
                                    ...
                                    ?>
                                        ...
                                        <div class="post" style="padding-left: 10px;">
                                            ...
                                            <h4 class="trends"><a id="trends" href="new_detail.php?id=<?php echo $row_news['id']; ?>"><?php echo $row_news['title']; ?></a></h4>
                                            <span style="font-size:medium;"> <i class="fa fa-calendar-alt"></i>  <?php echo date("M, d Y", strtotime($row_news['created_at'])); ?></span>
                                            <hr>
